...
export default {
  ...
  methods: {
    ...
    getDateList: function(date) {
      ...
      axios({
        method:'get',
        url:'http://v3.wufazhuce.com:8000/api/onelist/' + date + '/0?cchannel=wdj&version=4.0.2&uuid=ffffffff-a90e-706a-63f7-ccf973aae5ee&platform=android',
      })
        .then(function(res) {
            _this.pageInfo = res.data.data.content_list
